...
export function Quest() {
  ...
  var surveyJSON = {
    ...
    "pages":[
      {"name":"page1","elements":[
        {"type":"radiogroup","name":"question1","title":"Are you experiencing any of the following...","description":"Severe difficulty breathing (e.g., struggling for each breath, speaking in single words), severe chest pain, having a very hard time waking up, feeling confused, lost consciousness","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]},
        {"type":"radiogroup","name":"question2","title":"Are you experience any of the following...","description":"Shortness of breath at rest, inability to lie down because of difficulty breathing, chronic health conditions that you are having difficulty managing because of your current respiratory illness","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]},
        {"type":"radiogroup","name":"question3","title":"In the past 10 days, have you experienced any of the following:","description":"Fever, new onset of cough or worsening of chronic cough, new or worsening shortness of breath, new or worsening difficulty breathing, sore throat, runny nose","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]},
        {"type":"radiogroup","name":"question4","title":"Do you have any of the following:","description":"Chills, painful swallowing, stuffy nose, headache, muscle or joint ache, feeling unwell, fatigue or severe exhaustion, nausea, vomiting, diarrhea or unexplained loss of appetite, loss of sense of smell or taste, conjunctivitis (pink eye)\n","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]},
        {"type":"radiogroup","name":"question5","title":"In the past 14 days, were you notified that you are connected to an outbreak OR that you are a close contact of a confirmed case of COVID-19 by:","description":"AHS, Your employer, Someone who tested positive for COVID-19","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]},
        {"type":"radiogroup","name":"question6","title":"In the past 14 days, did you return from travel outside of your Country?","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]},
        {"type":"radiogroup","name":"question7","title":"Do you require testing for the purpose of outgoing travel?","isRequired":true,"choices":[
          {"value":"item1","text":"Yes"},
          {"value":"item2","text":"No"}]
        }
      ]}

...
declare namespace H.service.xyz {
  ...
  class Service extends H.service.Service {
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesByBoundingBox (spaceId : string , params : GlobalObject , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     * @param onError A callback function to be called in case of failed request.
     */
    getFeaturesById (spaceId : string , params : GlobalObject , onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any ) : H.util.ICancelable | null ;
    /**
     ...
     */
    getSpaces (onResult : (a : GlobalObject | null ) => any , onError : (a : Error | null ) => any , opt_params ? : GlobalObject | null ) : H.util.ICancelable | null ;
    /**
...
declare namespace H.service.xyz.Service {
  type Options = { baseUrl ? : string , headers ? : GlobalObject | null , path ? : string , subDomain ? : string , token : string } ;
}

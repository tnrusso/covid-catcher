...
layers:
  ...
  boundaries:
    ...
    draw:
      translucent-lines:
        order: 500
    border-labels:
      filter: {$zoom: {min: global.boundary.labels.zoom.min}}
      draw:
        text-blend-order:
  ...
  buildings:
    ...
    labels:
      ...
      draw:
        points:
          # Color and size are needed to activate label rendering:
          color: red
          size: 0px
          placement: centroid
          text:
  ...
  places:
    ...
    populated-places:
      ...
      population-1m-up:
        ...
        draw:
          icon_library:
            priority: global.label.priorities.city-center-class1
        ...
        capital:
          ...
          draw:
            icon_library:
              ...
              priority: global.label.priorities.city-center-country-capital-class1
              text:
                priority: global.label.priorities.city-center-country-capital-class1
                font:
        ...
        region-capital:
          ...
          draw:
            icon_library:
              ...
              priority: global.label.priorities.city-center-state-capital-class1
              text:
                priority: global.label.priorities.city-center-state-capital-class1
        county-capital:
          filter:
      ...
      population-250k-1m:
        ...
        draw:
          icon_library:
            priority: global.label.priorities.city-center-class2
            visible: global.icon_visible_populated_places
            text:
              priority: global.label.priorities.city-center-class2
              font:
        ...
        capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--capital_day
              priority: global.label.priorities.city-center-country-capital-class2
              text:
                priority: global.label.priorities.city-center-country-capital-class2
                font:
                  fill: global.place_capital_color
        ...
        region-capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--square_day
              priority: global.label.priorities.city-center-state-capital-class2
              text:
                priority: global.label.priorities.city-center-state-capital-class2
        county-capital:
          filter:
      ...
      population-100k-250k:
        ...
        draw:
          icon_library:
            priority: global.label.priorities.city-center-class3
            visible: global.icon_visible_populated_places
            text:
              priority: global.label.priorities.city-center-class3
              font:
        ...
        capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--capital_day
              priority: global.label.priorities.city-center-country-capital-class3
              text:
                priority: global.label.priorities.city-center-country-capital-class3
                font:
                  fill: global.place_capital_color
        ...
        region-capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--square_day
              priority: global.label.priorities.city-center-state-capital-class3
              text:
                priority: global.label.priorities.city-center-state-capital-class3
        county-capital:
          filter:
      ...
      population-30k-100k:
        ...
        draw:
          icon_library:
            priority: global.label.priorities.city-center-class4
            visible: global.icon_visible_populated_places
            text:
              priority: global.label.priorities.city-center-class4
              font:
        ...
        capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--capital_day
              priority: global.label.priorities.city-center-country-capital-class4
              text:
                priority: global.label.priorities.city-center-country-capital-class4
                font:
                  fill: global.place_capital_color
        ...
        region-capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--square_day
              priority: global.label.priorities.city-center-state-capital-class4
              text:
                priority: global.label.priorities.city-center-state-capital-class4
        county-capital:
          filter:
      ...
      population-until-30k:
        ...
        draw:
          icon_library:
            priority: global.label.priorities.city-center-class5
            visible: global.text_visible_populated_places
            text:
              priority: global.label.priorities.city-center-class5
              font:
        ...
        capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--capital_day
              priority: global.label.priorities.city-center-country-capital-class5
              text:
                priority: global.label.priorities.city-center-country-capital-class5
                font:
                  fill: global.place_capital_color
        ...
        region-capital:
          ...
          draw:
            icon_library:
              ...
              sprite: city-center--square_day
              priority: global.label.priorities.city-center-state-capital-class5
              text:
                priority: global.label.priorities.city-center-state-capital-class5
        county-capital:
          filter:
        ...
        icon_library:
          ...
          text:
            ...
            font:
              ...
              stroke:
                width: global.poi.label.font.stroke.width
                color: global.peak_label_outline_color
              size: global.poi.label.font.size
      peak:
        filter: {kind: peak}
        draw:
          icon_library:
